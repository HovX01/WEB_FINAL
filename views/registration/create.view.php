    ...
    <div class="register register-with-news-feed">
        ...
        <div class="register-container">
            ...
            <div class="register-content">
                <form action="/register" method="POST" class="fs-13px" data-parsley-validate="true">
                    <ul>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="username" class="form-control fs-13px" data-parsley-required="true" placeholder="Username" />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-4 pb-5">
                        Already a account? Click <a href="/login">here</a> to login.
                    </div>
                </form>
            </div>
